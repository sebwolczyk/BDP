...
--obiekt2
INSERT INTO obiekty VALUES
(2,'obiekt2',ST_GeomFromText('CURVEPOLYGON(COMPOUNDCURVE(
													   	(10 2, 10 6, 14 6),
...
SELECT ST_Area(ST_Buffer(ST_ShortestLine(
										...
										(SELECT geometria FROM obiekty WHERE id = 4)),5)) AS pole
...
INSERT INTO obiekty VALUES
(7,'obiekt7',ST_GeomFromText('MULTIPOLYGON(((7 15,10 17,12 13,7 15)),
